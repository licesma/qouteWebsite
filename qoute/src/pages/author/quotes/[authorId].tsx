...
import { useAuthorName, useAuthorQuotes } from "@/components/api/AuthorApi";
import {
  useAuthorPicture,
...
export const AuthorPage: React.FunctionComponent<{ authorId: string }> = (
  ...
  const { data: quotes } = useAuthorQuotes(authorId);
    ...
    <main className={styles.main}>
      ...
      <div className={styles.authorPageContainer}>
        <div className={styles.authorContainer}>
          ...
          <div className={styles.quotesFrame}>
            {quotes ? <QuoteContainer quotes={quotes} hideAuthor /> : null}
          </div>
        </div>
      </div>
    </main>
